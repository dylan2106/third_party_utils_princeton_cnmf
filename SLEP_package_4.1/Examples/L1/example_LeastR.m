...
tic;
[x1, funVal1, ValueL1]= LeastR([ones(m,1), A], y, rho, opts);
toc;
...
tic;
[x2, funVal2, ValueL2]= LeastR([ones(m,1), A], y, rho, opts);
toc;
...
opts.tFlag=2; opts.tol= funVal1(end);
tic;
[x3, funVal3, ValueL3]= LeastR([ones(m,1), A], y, rho, opts);
toc;
...
X=pathSolutionLeast([ones(m,1), A], y, Z, opts);